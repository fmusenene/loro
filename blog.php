                ...
                <div class="col-lg-8 col-md-7">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <h3><a href="./blog-details.php">Get Best Advertiser In Your Side Pocket</a></h3>
                            <ul>
                    ...
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <h3><a href="./blog-details.php">Internet Advertising Trends You Won T Be Disappointed</a></h3>
                            <ul>
                                <li><i class="fa fa-clock-o"></i> 19th March, 2019</li>
                                <li><i class="fa fa-user"></i> John Smith</li>
                            </ul>
                    ...
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <h3><a href="./blog-details.php">Freelance Design Tricks How To Get Away With Murder</a></h3>
                            <ul>
                                <li><i class="fa fa-clock-o"></i> 19th March, 2019</li>
                                <li><i class="fa fa-user"></i> John Smith</li>
                            </ul>
                    ...
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <h3><a href="./blog-details.php">Advertise No Matter If You Are Big Or Small</a></h3>
                            <ul>
                                <li><i class="fa fa-clock-o"></i> 19th March, 2019</li>
                                <li><i class="fa fa-user"></i> John Smith</li>
                            </ul>
